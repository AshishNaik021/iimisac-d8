...
class Serializer implements SerializerInterface {
  ...
  /**
   * Drupal\fillpdf\EntityHelper definition.
   *
   ...
   * Constructor.
   */
  public function __construct(SymfonySerializer $serializer, EntityHelper $entity_helper, EntityTypeManagerInterface $entity_type_manager) {
  ...
  public function importFormFields(array $keyed_fields, array $existing_fields = []) {
    ...
    /**
     * @var string $pdf_key
     * @var FillPdfFormFieldInterface $keyed_field
     */
